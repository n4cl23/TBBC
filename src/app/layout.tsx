...
export const metadata: Metadata = {
  metadataBase: new URL('https://blackbannerchronicles.com'),
  title: {
    default: 'The Black Banner Chronicles',
    template: '%s | The Black Banner Chronicles',
  },
  description:
  ...
  openGraph: {
    type: 'website',
    locale: 'pt_BR',
    title: 'The Black Banner Chronicles',
    description: 'Um mundo contado em resina.',
